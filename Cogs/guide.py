...
class guide(commands.Cog):
    ...
    async def Kamil(self, ctx):
        await ctx.send("https://cdn.discordapp.com/attachments/728613262488502293/736310221168836678/Screenshot_20200724-145418_Knighthood.jpg")
    ...
    async def Lukin(self, ctx):
        await ctx.send("https://cdn.discordapp.com/attachments/728613262488502293/732942479917187134/image0-13.png")
