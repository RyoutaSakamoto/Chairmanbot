...
extensions = ['Cogs.administrator', 'Cogs.Activity', 'Cogs.misc commands', 'Cogs.Help','Cogs.random','Cogs.time','Cogs.slots', 'Cogs.guide']
...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Game(name="Roast Slayers"))
